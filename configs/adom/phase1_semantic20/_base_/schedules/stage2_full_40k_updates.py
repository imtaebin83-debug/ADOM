...
optimizer_updates = int("{{$ADOM_MAX_OPTIMIZER_UPDATES:40000}}")
warmup_updates = min(
    int("{{$ADOM_WARMUP_OPTIMIZER_UPDATES:500}}"), optimizer_updates
)
val_updates = int("{{$ADOM_VAL_INTERVAL_OPTIMIZER_UPDATES:1000}}")
