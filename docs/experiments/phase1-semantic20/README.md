...
| TA0 | RELLIS, B0-E0 warm start | RELLIS | RELLIS | continued-training control |
| TA1 | RELLIS + ADOM ZED2i | RELLIS | RELLIS | 신규 target-domain data 순효과 |
| TA2 | RELLIS + RUGD + YCOR + ADOM ZED2i | RELLIS | RELLIS | multi-source 상보 효과 |
