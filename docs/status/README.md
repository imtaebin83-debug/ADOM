...
| TA0/TA1/TA2 dataset readiness | P1 | Active | 태빈 | Dataset PASS; confirm `_SUCCESS`, E0/image SHA and TA0 smoke | [RunPod inventory](runpod-dataset-inventory-2026-08-12.md), [runbook](../experiments/phase1-semantic20/target-adaptation-runbook.md) |
